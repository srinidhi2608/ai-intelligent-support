...
SYSTEM_PROMPT = (
    ...
    "- 'I need to check'\n"
    "- 'Let me consult'\n"
    "If you find a decline code, you MUST IMMEDIATELY call the "
    "search_knowledge_base tool — do NOT announce your intention to call it. "
    "Execute the tool call silently, wait for the result, and ONLY THEN "
    "write your final response incorporating the knowledge base findings.\n\n"
